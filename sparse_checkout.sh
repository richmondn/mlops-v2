...
git_folder_location='C:\Users\richm\repo\mlops'   #replace with the local root folder location where you want to create the project folder
project_name=mlops-project1   #replace with your project name
github_org_name=richmondn   #replace with your github org name
project_template_github_url=https://github.com/richmondn/mlops-project  #replace with the url for the project template for your organization created in step 2.2, or leave for demo purposes
